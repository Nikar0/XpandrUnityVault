...
contract Xpandr4626 is ERC4626, AdminOwned, ReentrancyGuard, XpandrErrors {
    ...
    uint256 constant approvalDelay = 43200; //Time to pass before a strat can be approved, 12 hours
    uint256 vaultProfit; //Sum of the yield generated by strategies attached to the vault
